...
module Sobel_allDirections_Filter2D119 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] src_kernel_win_0_val_0_0_3_reg_1175;
reg   [7:0] ap_reg_ppstg_src_kernel_win_0_val_0_0_3_reg_1175_pp0_iter4;
...
wire  signed [18:0] grp_fu_851_p3;
...
wire   [7:0] col_buf_0_val_0_0_3_fu_563_p3;
...
reg   [7:0] col_buf_0_val_0_0_4_fu_116;
...
wire   [0:0] ult3_fu_505_p2;
wire   [0:0] rev3_fu_510_p2;
...
wire  signed [16:0] grp_fu_866_p3;
wire  signed [16:0] grp_fu_858_p3;
...
wire  signed [19:0] grp_fu_834_p3;
...
wire   [15:0] grp_fu_834_p00;
wire   [15:0] grp_fu_844_p00;
wire   [15:0] grp_fu_851_p00;
wire   [15:0] grp_fu_858_p00;
wire   [15:0] grp_fu_866_p00;
...
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 17 ))
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1_U89(
    .din0(grp_fu_826_p0),
    .din1(grp_fu_826_p1),
...
Sobel_allDirections_mac_muladd_8ns_8s_19s_20_1 #(
    ...
    .din2_WIDTH( 19 ),
    .dout_WIDTH( 20 ))
Sobel_allDirections_mac_muladd_8ns_8s_19s_20_1_U90(
    .din0(grp_fu_834_p0),
    .din1(grp_fu_834_p1),
...
Sobel_allDirections_mac_muladd_8ns_8s_17s_18_1 #(
    ...
    .din2_WIDTH( 17 ),
    .dout_WIDTH( 18 ))
Sobel_allDirections_mac_muladd_8ns_8s_17s_18_1_U91(
    .din0(grp_fu_844_p0),
    .din1(grp_fu_844_p1),
    .din2(grp_fu_826_p3),
    .dout(grp_fu_844_p3)
...
Sobel_allDirections_mac_muladd_8ns_8s_18s_19_1 #(
    ...
    .din2_WIDTH( 18 ),
    .dout_WIDTH( 19 ))
Sobel_allDirections_mac_muladd_8ns_8s_18s_19_1_U92(
    .din0(grp_fu_851_p0),
    .din1(grp_fu_851_p1),
...
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 17 ))
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1_U93(
    .din0(grp_fu_858_p0),
    .din1(grp_fu_858_p1),
...
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 17 ))
Sobel_allDirections_mac_muladd_8ns_8s_16s_17_1_U94(
    .din0(grp_fu_866_p0),
    .din1(grp_fu_866_p1),
...
always @ (posedge ap_clk) begin
    if (ap_sig_476) begin
        if (ap_sig_891) begin
            ...
            src_kernel_win_0_val_0_0_fu_144 <= col_buf_0_val_0_0_3_fu_563_p3;
...
always @ (posedge ap_clk) begin
    if (~(((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_277) | ((1'b1 == ap_reg_ppiten_pp0_it6) & ap_sig_281))) begin
        ...
        ap_reg_ppstg_src_kernel_win_0_val_0_0_3_reg_1175_pp0_iter4 <= src_kernel_win_0_val_0_0_3_reg_1175;
        ...
        src_kernel_win_0_val_0_0_3_reg_1175 <= src_kernel_win_0_val_0_0_fu_144;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it2) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_277) | ((1'b1 == ap_reg_ppiten_pp0_it6) & ap_sig_281)) & ~(1'b0 == ap_reg_ppstg_tmp_16_i_reg_1102_pp0_iter1))) begin
        col_buf_0_val_0_0_4_fu_116 <= p_0110_6_i_i_phi_fu_315_p6;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it4) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_277) | ((1'b1 == ap_reg_ppiten_pp0_it6) & ap_sig_281)) & (1'b0 == ap_reg_ppstg_brmerge303_i_i_reg_1144_pp0_iter3))) begin
        tmp2_reg_1210 <= grp_fu_851_p3;
        tmp3_reg_1215 <= grp_fu_844_p3;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it2) & ~(1'b0 == ap_reg_ppstg_tmp_16_i_reg_1102_pp0_iter1) & ~(1'b0 == ap_reg_ppstg_brmerge_i_i_reg_1128_pp0_iter1))) begin
        col_buf_0_val_0_0_phi_fu_305_p4 = col_buf_0_val_0_0_4_fu_116;
    end else begin
...
always @ (*) begin
    if (ap_sig_507) begin
        if (~(1'b0 == tmp_13_i_reg_1083)) begin
            ...
            k_buf_0_val_0_d1 = col_buf_0_val_0_0_3_fu_563_p3;
        end else begin
            k_buf_0_val_0_d1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it2) & ~(1'b0 == ap_reg_ppstg_tmp_16_i_reg_1102_pp0_iter1) & ~(1'b0 == ap_reg_ppstg_tmp_19_i_reg_1111_pp0_iter1) & (1'b0 == tmp_13_i_reg_1083))) begin
        p_0110_6_i_i_phi_fu_315_p6 = col_buf_0_val_0_0_3_fu_563_p3;
...
assign brmerge_i_i_fu_516_p2 = (rev3_fu_510_p2 | rev_reg_1097);

assign col_assign_cast_i_cast_fu_474_p1 = p_021_0_i_i_reg_291;

assign col_buf_0_val_0_0_3_fu_563_p3 = ((tmp_14_i_reg_1087[0:0] === 1'b1) ? col_buf_0_val_0_0_phi_fu_305_p4 : ap_const_lv8_0);
...
assign grp_fu_826_p00 = p_src_kernel_win_0_val_0_2_i_reg_1190;

assign grp_fu_826_p1 = OP2_V_0_2_i_reg_1059;

assign grp_fu_834_p0 = grp_fu_834_p00;

assign grp_fu_834_p00 = ap_reg_ppstg_src_kernel_win_0_val_0_0_3_reg_1175_pp0_iter4;

assign grp_fu_834_p1 = OP2_V_0_2_2_i_reg_1069;

assign grp_fu_844_p0 = grp_fu_844_p00;

assign grp_fu_844_p00 = src_kernel_win_0_val_1_0_reg_339;

assign grp_fu_844_p1 = OP2_V_0_1_2_i_reg_1054;

assign grp_fu_851_p0 = grp_fu_851_p00;

assign grp_fu_851_p00 = p_src_kernel_win_0_val_1_1_i_reg_1185;

assign grp_fu_851_p1 = OP2_V_0_1_1_i_reg_1049;

assign grp_fu_858_p0 = grp_fu_858_p00;

assign grp_fu_858_p00 = src_kernel_win_0_val_2_0_reg_325;

assign grp_fu_858_p1 = OP2_V_0_0_2_i_reg_1039;

assign grp_fu_866_p0 = grp_fu_866_p00;

assign grp_fu_866_p00 = p_src_kernel_win_0_val_2_2_i_reg_1180;

assign grp_fu_866_p1 = OP2_V_0_0_i_reg_1029;
...
assign isneg_fu_767_p3 = grp_fu_834_p3[ap_const_lv32_13];
...
assign p_Result_7_i_i_i_fu_777_p4 = {{grp_fu_834_p3[ap_const_lv32_13 : ap_const_lv32_8]}};
...
assign p_Val2_6_fu_774_p1 = grp_fu_834_p3[7:0];

assign p_Val2_8_0_0_1_cast_i_fu_713_p1 = grp_fu_866_p3;
...
assign p_Val2_s_fu_818_p3 = ((tmp_i_i_i_fu_812_p2[0:0] === 1'b1) ? p_mux_i_i_cast_i_fu_804_p3 : p_Val2_6_fu_774_p1);
...
assign rev3_fu_510_p2 = (ult3_fu_505_p2 ^ 1'b1);
...
assign tmp1_cast_fu_723_p1 = grp_fu_858_p3;
...
assign ult3_fu_505_p2 = ((p_021_0_i_i_reg_291 < p_src_cols_V_read_reg_930) ? 1'b1 : 1'b0);
...
endmodule //Sobel_allDirections_Filter2D119

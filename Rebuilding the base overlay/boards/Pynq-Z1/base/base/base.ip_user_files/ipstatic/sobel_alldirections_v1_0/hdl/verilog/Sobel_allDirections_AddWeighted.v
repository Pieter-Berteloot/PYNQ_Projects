...
module Sobel_allDirections_AddWeighted (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_89)) begin
        cols_V_reg_186 <= src1_cols_V_dout;
        rows_V_reg_181 <= src1_rows_V_dout;
    end
end
...
always @ (*) begin
    ap_sig_111 = (((exitcond_i_i_i_reg_200 == 1'b0) & (src1_data_stream_V_empty_n == 1'b0)) | ((exitcond_i_i_i_reg_200 == 1'b0) & (src2_data_stream_V_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_sig_89 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (src1_rows_V_empty_n == 1'b0) | (src1_cols_V_empty_n == 1'b0));
end
...
assign lhs_V_1_i_cast_i_i_cast_fu_149_p1 = src1_data_stream_V_dout;

assign overflow_fu_165_p3 = sum_V_fu_159_p2[ap_const_lv32_8];

assign p_Val2_11_fu_153_p2 = (src1_data_stream_V_dout + src2_data_stream_V_dout);

assign p_Val2_s_fu_173_p3 = ((overflow_fu_165_p3[0:0] === 1'b1) ? ap_const_lv8_FF : p_Val2_11_fu_153_p2);

assign r_V_i_cast1_i_i_cast_fu_145_p1 = src2_data_stream_V_dout;

assign sum_V_fu_159_p2 = (r_V_i_cast1_i_i_cast_fu_145_p1 + lhs_V_1_i_cast_i_i_cast_fu_149_p1);

endmodule //Sobel_allDirections_AddWeighted

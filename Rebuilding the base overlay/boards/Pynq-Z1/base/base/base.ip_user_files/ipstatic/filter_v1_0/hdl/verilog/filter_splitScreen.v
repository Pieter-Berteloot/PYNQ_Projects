...
reg   [0:0] exitcond_i4_reg_113;
reg   [10:0] col_i3_reg_127;
reg   [20:0] indvar_flatten2_reg_141;
wire   [7:0] tmp_6_fu_169_p3;
reg   [7:0] tmp_6_reg_219;
wire   [7:0] tmp_7_fu_177_p3;
reg   [7:0] tmp_7_reg_224;
wire   [7:0] tmp_8_fu_185_p3;
reg   [7:0] tmp_8_reg_229;
...
reg   [0:0] exitcond_i_reg_244;
reg   [0:0] exitcond_flatten_reg_249;
reg    ap_sig_116;
reg   [0:0] exitcond_i4_phi_fu_117_p6;
reg   [10:0] col_i3_phi_fu_131_p6;
reg   [20:0] indvar_flatten2_phi_fu_145_p6;
wire   [10:0] col_i_mid2_fu_155_p3;
wire   [0:0] tmp_4_i_fu_163_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b1 == ap_reg_ppiten_pp0_it1) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)) & (1'b0 == exitcond_flatten_reg_249))) begin
        ...
        col_i3_reg_127 <= ap_const_lv11_0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b1 == ap_reg_ppiten_pp0_it1) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)) & (1'b0 == exitcond_flatten_reg_249))) begin
        exitcond_i4_reg_113 <= exitcond_i_reg_244;
    end else if ((((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_116) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b1 == ap_reg_ppiten_pp0_it1) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)) & ~(1'b0 == exitcond_flatten_reg_249)))) begin
        exitcond_i4_reg_113 <= 1'b0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)))) begin
        ...
        exitcond_i_reg_244 <= exitcond_i_fu_205_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)))) begin
        ...
        tmp_6_reg_219 <= tmp_6_fu_169_p3;
        tmp_7_reg_224 <= tmp_7_fu_177_p3;
        tmp_8_reg_229 <= tmp_8_fu_185_p3;
    end
end
...
always @ (*) begin
    if (ap_sig_92) begin
        if (~(1'b0 == exitcond_flatten_reg_249)) begin
            col_i3_phi_fu_131_p6 = ap_const_lv11_0;
        end else if ((1'b0 == exitcond_flatten_reg_249)) begin
            col_i3_phi_fu_131_p6 = col_reg_234;
        end else begin
            col_i3_phi_fu_131_p6 = col_i3_reg_127;
        end
    end else begin
        col_i3_phi_fu_131_p6 = col_i3_reg_127;
    end
...
always @ (*) begin
    if (ap_sig_92) begin
        if (~(1'b0 == exitcond_flatten_reg_249)) begin
            exitcond_i4_phi_fu_117_p6 = 1'b0;
        end else if ((1'b0 == exitcond_flatten_reg_249)) begin
            exitcond_i4_phi_fu_117_p6 = exitcond_i_reg_244;
        end else begin
            exitcond_i4_phi_fu_117_p6 = exitcond_i4_reg_113;
        end
    end else begin
        exitcond_i4_phi_fu_117_p6 = exitcond_i4_reg_113;
    end
...
always @ (*) begin
    ap_sig_77 = ((img_out_data_stream_0_V_full_n == 1'b0) | (img_out_data_stream_1_V_full_n == 1'b0) | (img_out_data_stream_2_V_full_n == 1'b0));
end
...
assign col_fu_193_p2 = (col_i_mid2_fu_155_p3 + ap_const_lv11_1);

assign col_i_mid2_fu_155_p3 = ((exitcond_i4_phi_fu_117_p6[0:0] === 1'b1) ? ap_const_lv11_0 : col_i3_phi_fu_131_p6);

assign exitcond_flatten_fu_211_p2 = ((indvar_flatten2_phi_fu_145_p6 == ap_const_lv21_1FA3FF) ? 1'b1 : 1'b0);

assign exitcond_i_fu_205_p2 = ((col_fu_193_p2 == ap_const_lv11_780) ? 1'b1 : 1'b0);

assign img_out_data_stream_0_V_din = tmp_6_reg_219;

assign img_out_data_stream_1_V_din = tmp_7_reg_224;

assign img_out_data_stream_2_V_din = tmp_8_reg_229;

assign indvar_flatten_next_fu_199_p2 = (indvar_flatten2_phi_fu_145_p6 + ap_const_lv21_1);

assign tmp_4_i_fu_163_p2 = ((col_i_mid2_fu_155_p3 > ap_const_lv11_3C0) ? 1'b1 : 1'b0);

assign tmp_6_fu_169_p3 = ((tmp_4_i_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_0_V_dout : ap_const_lv8_0);

assign tmp_7_fu_177_p3 = ((tmp_4_i_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_1_V_dout : ap_const_lv8_0);

assign tmp_8_fu_185_p3 = ((tmp_4_i_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_2_V_dout : ap_const_lv8_0);

endmodule //filter_splitScreen

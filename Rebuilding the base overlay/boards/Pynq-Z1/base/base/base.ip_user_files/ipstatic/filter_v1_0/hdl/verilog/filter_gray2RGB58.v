...
wire   [20:0] indvar_flatten_next_fu_118_p2;
reg    ap_sig_84;
reg   [20:0] indvar_flatten2_reg_104;
reg    ap_sig_55;
wire   [0:0] exitcond_flatten_fu_124_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_84 & ~(exitcond_flatten_fu_124_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_84 & (exitcond_flatten_fu_124_p2 == 1'b0))) begin
        indvar_flatten2_reg_104 <= indvar_flatten_next_fu_118_p2;
    end else if ((((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_55) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_84 & ~(exitcond_flatten_fu_124_p2 == 1'b0)))) begin
        indvar_flatten2_reg_104 <= ap_const_lv21_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_84 & ~(exitcond_flatten_fu_124_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_84)) begin
...
always @ (*) begin
    ap_sig_55 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
always @ (*) begin
    ap_sig_84 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (img_in_data_stream_V_empty_n == 1'b0) | (img_in_data_stream_V1_empty_n == 1'b0) | (img_in_data_stream_V2_empty_n == 1'b0) | (img_out_data_stream_V_full_n == 1'b0) | (img_out_data_stream_V3_full_n == 1'b0) | (img_out_data_stream_V4_full_n == 1'b0));
end

assign exitcond_flatten_fu_124_p2 = ((indvar_flatten2_reg_104 == ap_const_lv21_1FA3FF) ? 1'b1 : 1'b0);

assign img_out_data_stream_V3_din = img_in_data_stream_V_dout;

assign img_out_data_stream_V4_din = img_in_data_stream_V_dout;

assign img_out_data_stream_V_din = img_in_data_stream_V_dout;

assign indvar_flatten_next_fu_118_p2 = (indvar_flatten2_reg_104 + ap_const_lv21_1);

endmodule //filter_gray2RGB58

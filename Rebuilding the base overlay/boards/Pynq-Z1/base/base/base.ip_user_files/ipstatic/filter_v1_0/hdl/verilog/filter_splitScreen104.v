...
reg   [7:0] tmp_reg_219;
wire   [7:0] tmp_1_fu_177_p3;
reg   [7:0] tmp_1_reg_224;
wire   [7:0] tmp_4_fu_185_p3;
reg   [7:0] tmp_4_reg_229;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & ~(((1'b1 == ap_reg_ppiten_pp0_it0) & ap_sig_58) | (ap_sig_77 & (1'b1 == ap_reg_ppiten_pp0_it1)) | (ap_done_reg == 1'b1)))) begin
        ...
        tmp_1_reg_224 <= tmp_1_fu_177_p3;
        tmp_4_reg_229 <= tmp_4_fu_185_p3;
...
assign img_out_data_stream_V3_din = tmp_1_reg_224;

assign img_out_data_stream_V4_din = tmp_4_reg_229;
...
assign tmp_1_fu_177_p3 = ((tmp_5_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_V1_dout : ap_const_lv8_0);

assign tmp_4_fu_185_p3 = ((tmp_5_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_V2_dout : ap_const_lv8_0);

assign tmp_5_fu_163_p2 = ((col_mid2_fu_155_p3 < ap_const_lv11_3C1) ? 1'b1 : 1'b0);

assign tmp_fu_169_p3 = ((tmp_5_fu_163_p2[0:0] === 1'b1) ? img_in_data_stream_V_dout : ap_const_lv8_0);

endmodule //filter_splitScreen104

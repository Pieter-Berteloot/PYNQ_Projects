...
module filter_AXIvideo2Mat119 (
        ...
        index2_out_write,
        splitIndex_out_din,
        splitIndex_out_full_n,
        splitIndex_out_write,
        mode1_out_din,
        mode1_out_full_n,
        mode1_out_write,
...
output  [7:0] dir_out_din;
input   dir_out_full_n;
output   dir_out_write;
output  [31:0] index2_out_din;
input   index2_out_full_n;
output   index2_out_write;
output  [31:0] splitIndex_out_din;
input   splitIndex_out_full_n;
output   splitIndex_out_write;
...
wire   [0:0] exitcond1_i_i_fu_480_p2;
wire   [0:0] brmerge_i_i_fu_495_p2;
reg    ap_sig_cseq_ST_pp2_stg0_fsm_5;
reg    ap_sig_348;
reg    ap_reg_ppiten_pp2_it0;
reg    ap_reg_ppiten_pp2_it1;
reg   [0:0] eol_2_i_i_phi_fu_405_p4;
reg    img_data_stream_0_V_blk_n;
reg   [0:0] exitcond1_i_i_reg_562;
...
reg    splitIndex_out_blk_n;
reg    mode1_out_blk_n;
reg    modeOriginal_out_blk_n;
reg   [10:0] p_5_i_i_reg_332;
reg   [0:0] eol_i_i_reg_343;
reg   [0:0] eol_reg_355;
reg   [23:0] axi_data_V_1_i_i_reg_366;
reg   [0:0] eol_2_i_i_reg_402;
reg   [0:0] axi_last_V_3_i_i_reg_413;
reg   [23:0] axi_data_V_3_i_i_reg_425;
reg   [23:0] reg_437_0;
reg   [0:0] reg_437_4;
reg    ap_sig_416;
reg    ap_sig_426;
reg    ap_sig_433;
reg   [23:0] tmp_data_V_reg_533;
reg   [0:0] tmp_last_V_reg_541;
wire   [0:0] exitcond9_i_i_fu_468_p2;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_452;
wire   [10:0] i_V_fu_474_p2;
reg   [10:0] i_V_reg_557;
wire   [10:0] j_V_fu_486_p2;
reg   [0:0] brmerge_i_i_reg_571;
reg   [0:0] axi_last_V1_i_i_reg_301;
reg    ap_sig_cseq_ST_st9_fsm_6;
reg    ap_sig_486;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_493;
reg   [23:0] axi_data_V1_i_i_reg_311;
reg   [10:0] p_i_i_reg_321;
reg   [0:0] eol_i_i_phi_fu_347_p4;
reg   [0:0] axi_last_V_2_i_i_phi_fu_382_p4;
reg   [23:0] p_Val2_s_phi_fu_394_p4;
wire   [0:0] ap_reg_phiprechg_axi_last_V_2_i_i_reg_377pp1_it1;
wire   [23:0] ap_reg_phiprechg_p_Val2_s_reg_390pp1_it1;
reg    ap_sig_541;
reg   [0:0] sof_1_i_i_fu_132;
wire   [0:0] tmp_user_V_fu_455_p1;
reg   [6:0] ap_NS_fsm;
reg    ap_sig_364;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_468_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(exitcond1_i_i_fu_480_p2 == 1'b0))) begin
            ap_reg_ppiten_pp1_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_468_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & ~(1'b0 == eol_2_i_i_phi_fu_405_p4))) begin
            ap_reg_ppiten_pp2_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b0 == exitcond1_i_i_reg_562))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        axi_data_V1_i_i_reg_311 <= tmp_data_V_reg_533;
    end else if ((1'b1 == ap_sig_cseq_ST_st9_fsm_6)) begin
        axi_data_V1_i_i_reg_311 <= axi_data_V_3_i_i_reg_425;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_562) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        axi_data_V_1_i_i_reg_366 <= p_Val2_s_phi_fu_394_p4;
    end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_468_p2))) begin
        axi_data_V_1_i_i_reg_366 <= axi_data_V1_i_i_reg_311;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b0 == exitcond1_i_i_reg_562))) begin
        axi_data_V_3_i_i_reg_425 <= axi_data_V_1_i_i_reg_366;
    end else if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & (1'b0 == eol_2_i_i_reg_402))) begin
        axi_data_V_3_i_i_reg_425 <= reg_437_0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        axi_last_V1_i_i_reg_301 <= tmp_last_V_reg_541;
    end else if ((1'b1 == ap_sig_cseq_ST_st9_fsm_6)) begin
        axi_last_V1_i_i_reg_301 <= axi_last_V_3_i_i_reg_413;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b0 == exitcond1_i_i_reg_562))) begin
        axi_last_V_3_i_i_reg_413 <= eol_reg_355;
    end else if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & (1'b0 == eol_2_i_i_reg_402))) begin
        axi_last_V_3_i_i_reg_413 <= reg_437_4;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b0 == exitcond1_i_i_reg_562))) begin
        eol_2_i_i_reg_402 <= eol_i_i_reg_343;
    end else if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & (1'b0 == eol_2_i_i_reg_402))) begin
        eol_2_i_i_reg_402 <= reg_437_4;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_562) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        eol_i_i_reg_343 <= axi_last_V_2_i_i_phi_fu_382_p4;
    end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_468_p2))) begin
        eol_i_i_reg_343 <= 1'b0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_562) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        eol_reg_355 <= axi_last_V_2_i_i_phi_fu_382_p4;
    end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_468_p2))) begin
        eol_reg_355 <= axi_last_V1_i_i_reg_301;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_480_p2 == 1'b0) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        p_5_i_i_reg_332 <= j_V_fu_486_p2;
    end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_468_p2))) begin
        p_5_i_i_reg_332 <= ap_const_lv11_0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        p_i_i_reg_321 <= ap_const_lv11_0;
    end else if ((1'b1 == ap_sig_cseq_ST_st9_fsm_6)) begin
        p_i_i_reg_321 <= i_V_reg_557;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_480_p2 == 1'b0) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        sof_1_i_i_fu_132 <= 1'b0;
    end else if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        sof_1_i_i_fu_132 <= 1'b1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond1_i_i_fu_480_p2 == 1'b0) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        brmerge_i_i_reg_571 <= brmerge_i_i_fu_495_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)))) begin
        exitcond1_i_i_reg_562 <= exitcond1_i_i_fu_480_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st4_fsm_3)) begin
        i_V_reg_557 <= i_V_fu_474_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_480_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_495_p2) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426))) | ((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it0) & (1'b0 == eol_2_i_i_phi_fu_405_p4) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433)))) begin
        reg_437_0 <= AXI_video_strm_V_data_V_0_data_out;
        reg_437_4 <= AXI_video_strm_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(AXI_video_strm_V_data_V_0_vld_out == 1'b0))) begin
        tmp_data_V_reg_533 <= AXI_video_strm_V_data_V_0_data_out;
        tmp_last_V_reg_541 <= AXI_video_strm_V_last_V_0_data_out;
    end
end

always @ (*) begin
    if ((((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_480_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_495_p2) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426))) | ((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it0) & (1'b0 == eol_2_i_i_phi_fu_405_p4) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433)) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(AXI_video_strm_V_data_V_0_vld_out == 1'b0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_468_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_468_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (ap_sig_364) begin
        if (~(1'b0 == brmerge_i_i_reg_571)) begin
            axi_last_V_2_i_i_phi_fu_382_p4 = eol_reg_355;
        end else if ((1'b0 == brmerge_i_i_reg_571)) begin
            axi_last_V_2_i_i_phi_fu_382_p4 = reg_437_4;
        end else begin
            axi_last_V_2_i_i_phi_fu_382_p4 = ap_reg_phiprechg_axi_last_V_2_i_i_reg_377pp1_it1;
        end
    end else begin
        axi_last_V_2_i_i_phi_fu_382_p4 = ap_reg_phiprechg_axi_last_V_2_i_i_reg_377pp1_it1;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_541)) begin
        dir_out_write = 1'b1;
    end else begin
        dir_out_write = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & (1'b0 == eol_2_i_i_reg_402))) begin
        eol_2_i_i_phi_fu_405_p4 = reg_437_4;
    end else begin
        eol_2_i_i_phi_fu_405_p4 = eol_2_i_i_reg_402;
    end
end

always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_562))) begin
        eol_i_i_phi_fu_347_p4 = axi_last_V_2_i_i_phi_fu_382_p4;
    end else begin
        eol_i_i_phi_fu_347_p4 = eol_i_i_reg_343;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) | ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_480_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_495_p2)) | ((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it0) & (1'b0 == eol_2_i_i_phi_fu_405_p4)))) begin
...
always @ (*) begin
    if (ap_sig_364) begin
        if (~(1'b0 == brmerge_i_i_reg_571)) begin
            p_Val2_s_phi_fu_394_p4 = axi_data_V_1_i_i_reg_366;
        end else if ((1'b0 == brmerge_i_i_reg_571)) begin
            p_Val2_s_phi_fu_394_p4 = reg_437_0;
        end else begin
            p_Val2_s_phi_fu_394_p4 = ap_reg_phiprechg_p_Val2_s_reg_390pp1_it1;
        end
    end else begin
        p_Val2_s_phi_fu_394_p4 = ap_reg_phiprechg_p_Val2_s_reg_390pp1_it1;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~((ap_start == 1'b0) | (ap_done_reg == 1'b1)))) begin
        splitIndex_out_blk_n = splitIndex_out_full_n;
    end else begin
        splitIndex_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_541)) begin
        splitIndex_out_write = 1'b1;
    end else begin
        splitIndex_out_write = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if ((~(AXI_video_strm_V_data_V_0_vld_out == 1'b0) & (1'b0 == tmp_user_V_fu_455_p1))) begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end else if ((~(AXI_video_strm_V_data_V_0_vld_out == 1'b0) & ~(1'b0 == tmp_user_V_fu_455_p1))) begin
        ...
        ap_ST_st4_fsm_3 : begin
            if (~(1'b0 == exitcond9_i_i_fu_468_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
        ...
        ap_ST_pp1_stg0_fsm_4 : begin
            if (~((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b1 == ap_reg_ppiten_pp1_it0))) begin
                ap_NS_fsm = ap_ST_pp1_stg0_fsm_4;
            end else if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_416) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_426)) & ~(1'b1 == ap_reg_ppiten_pp1_it0))) begin
        ...
        ap_ST_pp2_stg0_fsm_5 : begin
            if (~((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & ~(1'b1 == ap_reg_ppiten_pp2_it0))) begin
                ap_NS_fsm = ap_ST_pp2_stg0_fsm_5;
            end else if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_433) & ~(1'b1 == ap_reg_ppiten_pp2_it0))) begin
...
assign ap_reg_phiprechg_axi_last_V_2_i_i_reg_377pp1_it1 = 'bx;

assign ap_reg_phiprechg_p_Val2_s_reg_390pp1_it1 = 'bx;
...
always @ (*) begin
    ap_sig_328 = (1'b1 == ap_CS_fsm[ap_const_lv32_4]);
end

always @ (*) begin
    ap_sig_348 = (1'b1 == ap_CS_fsm[ap_const_lv32_5]);
end

always @ (*) begin
    ap_sig_364 = ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_562));
end

always @ (*) begin
    ap_sig_416 = ((exitcond1_i_i_fu_480_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_495_p2) & (AXI_video_strm_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_sig_426 = (((1'b0 == exitcond1_i_i_reg_562) & (img_data_stream_0_V_full_n == 1'b0)) | ((1'b0 == exitcond1_i_i_reg_562) & (img_data_stream_1_V_full_n == 1'b0)) | ((1'b0 == exitcond1_i_i_reg_562) & (img_data_stream_2_V_full_n == 1'b0)));
end

always @ (*) begin
    ap_sig_433 = ((1'b0 == eol_2_i_i_phi_fu_405_p4) & (AXI_video_strm_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_sig_452 = (1'b1 == ap_CS_fsm[ap_const_lv32_3]);
end

always @ (*) begin
    ap_sig_486 = (1'b1 == ap_CS_fsm[ap_const_lv32_6]);
end

always @ (*) begin
    ap_sig_493 = (1'b1 == ap_CS_fsm[ap_const_lv32_2]);
end

always @ (*) begin
    ap_sig_541 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (index3_out_full_n == 1'b0) | (mode2_out_full_n == 1'b0) | (mode_out_full_n == 1'b0) | (index_out_full_n == 1'b0) | (dir_out_full_n == 1'b0) | (index2_out_full_n == 1'b0) | (splitIndex_out_full_n == 1'b0) | (mode1_out_full_n == 1'b0) | (modeOriginal_out_full_n == 1'b0));
end

assign brmerge_i_i_fu_495_p2 = (sof_1_i_i_fu_132 | eol_i_i_phi_fu_347_p4);

assign dir_out_din = dir;

assign exitcond1_i_i_fu_480_p2 = ((p_5_i_i_reg_332 == ap_const_lv11_780) ? 1'b1 : 1'b0);

assign exitcond9_i_i_fu_468_p2 = ((p_i_i_reg_321 == ap_const_lv11_438) ? 1'b1 : 1'b0);

assign i_V_fu_474_p2 = (p_i_i_reg_321 + ap_const_lv11_1);

assign img_data_stream_0_V_din = p_Val2_s_phi_fu_394_p4[7:0];

assign img_data_stream_1_V_din = {{p_Val2_s_phi_fu_394_p4[ap_const_lv32_F : ap_const_lv32_8]}};

assign img_data_stream_2_V_din = {{p_Val2_s_phi_fu_394_p4[ap_const_lv32_17 : ap_const_lv32_10]}};
...
assign j_V_fu_486_p2 = (p_5_i_i_reg_332 + ap_const_lv11_1);
...
assign splitIndex_out_din = splitIndex;

assign tmp_user_V_fu_455_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //filter_AXIvideo2Mat119

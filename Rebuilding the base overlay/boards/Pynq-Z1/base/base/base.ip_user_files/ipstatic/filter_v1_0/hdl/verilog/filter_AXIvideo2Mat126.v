...
always @ (*) begin
    ap_sig_501 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (index3_out_full_n == 1'b0) | (index2_out_full_n == 1'b0) | (index_out_full_n == 1'b0) | (mode_out_full_n == 1'b0));
end
...
endmodule //filter_AXIvideo2Mat126

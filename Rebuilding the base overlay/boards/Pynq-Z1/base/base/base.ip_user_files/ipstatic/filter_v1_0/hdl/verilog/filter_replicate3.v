...
reg    ap_sig_126;
reg   [20:0] indvar_flatten2_reg_164;
reg    ap_sig_79;
wire   [0:0] exitcond_flatten_fu_184_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_126 & ~(exitcond_flatten_fu_184_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_126 & (exitcond_flatten_fu_184_p2 == 1'b0))) begin
        indvar_flatten2_reg_164 <= indvar_flatten_next_fu_178_p2;
    end else if ((((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_79) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_126 & ~(exitcond_flatten_fu_184_p2 == 1'b0)))) begin
        indvar_flatten2_reg_164 <= ap_const_lv21_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_126 & ~(exitcond_flatten_fu_184_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_126)) begin
...
always @ (*) begin
    ap_sig_126 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out2_data_stream_0_V_full_n == 1'b0) | (img_out2_data_stream_1_V_full_n == 1'b0) | (img_out2_data_stream_2_V_full_n == 1'b0));
end
...
always @ (*) begin
    ap_sig_79 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
assign exitcond_flatten_fu_184_p2 = ((indvar_flatten2_reg_164 == ap_const_lv21_1FA3FF) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next_fu_178_p2 = (indvar_flatten2_reg_164 + ap_const_lv21_1);

endmodule //filter_replicate3

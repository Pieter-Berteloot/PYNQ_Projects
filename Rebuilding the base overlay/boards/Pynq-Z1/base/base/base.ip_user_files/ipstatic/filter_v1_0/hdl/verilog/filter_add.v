...
wire   [20:0] indvar_flatten_next_fu_160_p2;
reg    ap_sig_105;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_105 & ~(exitcond_flatten_fu_166_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_105 & (exitcond_flatten_fu_166_p2 == 1'b0))) begin
        indvar_flatten2_reg_125 <= indvar_flatten_next_fu_160_p2;
    end else if ((((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_67) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_105 & ~(exitcond_flatten_fu_166_p2 == 1'b0)))) begin
        indvar_flatten2_reg_125 <= ap_const_lv21_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_105 & ~(exitcond_flatten_fu_166_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    ap_sig_105 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (img_in0_data_stream_0_V_empty_n == 1'b0) | (img_in0_data_stream_1_V_empty_n == 1'b0) | (img_in0_data_stream_2_V_empty_n == 1'b0) | (img_in1_data_stream_0_V_empty_n == 1'b0) | (img_in1_data_stream_1_V_empty_n == 1'b0) | (img_in1_data_stream_2_V_empty_n == 1'b0) | (img_out_data_stream_0_V_full_n == 1'b0) | (img_out_data_stream_1_V_full_n == 1'b0) | (img_out_data_stream_2_V_full_n == 1'b0));
end
...
assign exitcond_flatten_fu_166_p2 = ((indvar_flatten2_reg_125 == ap_const_lv21_1FA3FF) ? 1'b1 : 1'b0);

assign img_out_data_stream_0_V_din = (img_in0_data_stream_0_V_dout + img_in1_data_stream_0_V_dout);

assign img_out_data_stream_1_V_din = (img_in0_data_stream_1_V_dout + img_in1_data_stream_1_V_dout);

assign img_out_data_stream_2_V_din = (img_in0_data_stream_2_V_dout + img_in1_data_stream_2_V_dout);

assign indvar_flatten_next_fu_160_p2 = (indvar_flatten2_reg_125 + ap_const_lv21_1);

endmodule //filter_add

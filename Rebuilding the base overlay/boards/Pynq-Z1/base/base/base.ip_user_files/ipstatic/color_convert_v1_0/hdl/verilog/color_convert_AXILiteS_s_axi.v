...
//------------------------Local signal-------------------
    ...
    reg  [9:0]                    int_c3_c2_V;
    reg  [9:0]                    int_c3_c3_V;
    reg  [9:0]                    int_bias_c1_V;
    reg  [9:0]                    int_bias_c2_V;
    reg  [9:0]                    int_bias_c3_V;
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C1_C1_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C1_C2_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C1_C3_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C2_C1_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C2_C2_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C2_C3_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C3_C1_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C3_C2_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_C3_C3_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_BIAS_C1_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_BIAS_C2_V_DATA_0)
...
always @(posedge ACLK) begin
    if (rst)
        ...
        if (w_hs && waddr == ADDR_BIAS_C3_V_DATA_0)

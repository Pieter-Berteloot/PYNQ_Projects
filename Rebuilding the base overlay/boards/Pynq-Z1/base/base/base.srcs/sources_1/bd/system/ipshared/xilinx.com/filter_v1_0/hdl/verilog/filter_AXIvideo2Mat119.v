...
always @ (*) begin
    ap_sig_541 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (index_out_full_n == 1'b0) | (index2_out_full_n == 1'b0) | (mode2_out_full_n == 1'b0) | (modeOriginal_out_full_n == 1'b0) | (splitIndex_out_full_n == 1'b0) | (index3_out_full_n == 1'b0) | (mode_out_full_n == 1'b0) | (dir_out_full_n == 1'b0) | (mode1_out_full_n == 1'b0));
end
